...
int main(int argc, char *argv[])
{
	...
	g_signal_connect (G_OBJECT (button_attendance), "clicked", G_CALLBACK (attendance_clicked),NULL);
	g_signal_connect (G_OBJECT (button_notes), "clicked", G_CALLBACK (notes_clicked),NULL);
